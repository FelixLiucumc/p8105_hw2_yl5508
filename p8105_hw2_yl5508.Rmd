...
(a) There're `r nrow(bas_data)` participants recruited in the research. From the data, we notice `r nrow(bas_data_dropna)` participants develop MCI (deem NA as healthy condition, with NA the number would be `r nrow(bas_data_clean)`).
